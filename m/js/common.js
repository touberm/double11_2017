$(function(){
  ...
  var roll_h = (win_w-16)*520/914 + 16;
  ...
  $("#pandect .roll").css({'height':roll_h,'width':win_w});
  $("#pandect .roll ul").css({'width':roll_h*3,'height':win_w});
  $("#pandect .roll ul li").css({'width':roll_h,'height':win_w});
  $("#pandect .roll ul li img").css({'width':roll_h,'height':win_w});
